    ...
    npcs: [
      {
        ...
        randomDialogs: [
          ...
          { id: 'ch4_liu_casual_3', text: '他看了眼筆記本：「這本要是會說話，早就被滅口了。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_4', text: '「他們說節能，我聽到的是節省責任。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_5', text: '「別跟我談感覺。感覺不能當證物，頂多當副作用。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_6', text: '「我寧願你跟我吵數字，也不要你跟我演誠懇。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_7', text: '「光芒這邊的咖啡機比案情誠實——至少它真的會燙到人。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_8', text: '「你再看我一眼，我就多寫一行待查。我很認真的。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_9', text: '「公關稿寫得越漂亮，我越想把標點符號拿去驗指紋。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_casual_10', text: '「我今天心情還行，代表還沒人跟我說已結案。」', type: 'casual', weight: 2 },
          { id: 'ch4_liu_hint_1', text: '劉隊說：「先看樓梯間，再去找陳佑誠，那邊有東西要讓你看。」', type: 'hint', weight: 1 },
          { id: 'ch4_liu_hint_2', text: '「未遂事故不是沒有痕跡，是痕跡不夠整齊。你去找那個不夠整齊的地方。」', type: 'hint', weight: 1 },
          { id: 'ch4_liu_hint_3', text: '他把筆尖在紙上敲兩下：「我要的是能對上時間軸的東西，不是感覺。」', type: 'hint', weight: 1 },
          { id: 'ch4_liu_hint_4', text: '「陳佑誠那邊若肯開抽屜，你就會知道——有人早把答案寫過了。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
      {
        ...
        randomDialogs: [
          ...
          { id: 'ch4_liang_stair_casual_2', text: '「記者會那天我想對觀眾說：別怕黑，怕的是黑得剛剛好。結果鏡頭只拍得到穿制服的。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_3', text: '「我這輩子剪過很多片，沒剪過這麼離譜的現實。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_4', text: '「片尾字幕比我前任還難哄——至少字幕時間是準的。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_5', text: '「有人說導演難搞。我只是對『黑得太早』過敏。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_6', text: '「那天我要是戴帽T，可能會被當觀眾——可惜我穿得還是太像要負責的人。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_7', text: '「我最討厭的驚喜是：燈先走，人還在。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_8', text: '「觀眾罵人的時候很有創意，公司道歉稿永遠同一個模板。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_9', text: '「我現在看到扶手都多看一眼：它至少比某些簽核誠實。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_casual_10', text: '「你要我信節能？可以，先讓節能學會開燈。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_stair_hint_1', text: '梁以安說：「我不是難搞。我只是記得那次黑得太早。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_stair_hint_2', text: '「有人老說是節能。我聽起來比較像在試——遠端黑暗、人群慌起來會怎樣。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_stair_hint_3', text: '「片尾還在跑，燈先沒了。你說這像不像有人剪接過現實？」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_stair_hint_4', text: '梁以安苦笑：「他們要一個人鞠躬——挑了維護。導演跟觀眾一起罵。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
      {
        ...
        randomDialogs: [
          ...
          { id: 'ch4_chen_stair_casual_3', text: '「制服這件事我很熟——熟到想把它燙平。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_4', text: '「版本號背得比我老家電話還熟——這不正常。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_5', text: '「有人說我陰沈，其實我只是長期被已讀不回。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_6', text: '「燈控箱比我主管好懂：它至少照時間做事。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_7', text: '「我最怕的不是壞掉，是壞得像一切正常。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_8', text: '「抽屜最深那格不是藏寶，是藏我的耐心。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_9', text: '「遠端推送聽起來很帥，對維護來說通常是遠端推鍋。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_casual_10', text: '「你問我為什麼還在這？離職單也要有人簽——你猜誰不簽。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_stair_hint_1', text: '陳佑誠說：「系統不怕壞，怕的是壞得剛剛好，像正常老化。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_stair_hint_2', text: '「控制區那邊有更多東西，你先把樓梯這邊看完。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_stair_hint_3', text: '「你等等看到版本號，就會懂我為什麼急。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_stair_hint_4', text: '「三館同一套插件——洞留在授權樹頂層能看見的地方，就不是單一館倒楣。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
    ],
    ...
    npcs: [
      {
        ...
        portraitExpression: 1,
        randomDialogs: [
          { id: 'ch4_chen_control_casual_1', text: '「我寧願它壞得大聲，也不要壞得像正常。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_2', text: '陳佑誠敲敲抽屜：「有些東西放最底層，不是忘了，是等一個肯開的人。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_3', text: '「這間房的冷氣比簽核還冷——至少冷氣會自動除濕。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_4', text: '「維護帳號像共用衣櫃：你知道有人穿過，不知道今天是誰。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_5', text: '「patch 號多一點，責任就少一點——這是都市傳說。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_6', text: '「我若會變魔術，第一個把『無法重現』變不見。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_7', text: '「螢幕反光裡的我看起來像加班成精。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_8', text: '「有人說機房浪漫。浪漫個鬼，浪漫的是準時下班。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_9', text: '「我最討厭的提示音是：已送件。最討厭的安靜是：已讀不回。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_casual_10', text: '「同一套介面，三館同款——連我們的黑眼圈大概也是同款。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_control_hint_1', text: '陳佑誠說：「同一套插件跑三館，你還要我相信這些都是巧合？」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_control_hint_2', text: '「這個版本的插件可以遠端觸發燈控，不需要本地授權。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_control_hint_3', text: '「三份回報單——簽收過、進過系統，然後沒批示。你說那是忘記？」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_control_hint_4', text: '「遠端不代表神祕，只代表人不必站在這間房。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
      {
        ...
        portraitExpression: 1,
        randomDialogs: [
          { id: 'ch4_liang_control_casual_1', text: '「我以前只在乎片尾字幕的美感——對作品與現場的尊重。現在我只在乎它亮不亮。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_2', text: '梁以安低聲：「最侮辱的是什麼？他們用節能兩個字安慰觀眾。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_3', text: '「我在機房像個導演外殼——只剩脾氣是對的。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_4', text: '「片尾字幕的長度，剛好夠我罵完兩句。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_5', text: '「有人說我情緒化。我只是在跟錯拍對抗。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_6', text: '「我這行最離譜的是：觀眾以為我在控制，其實我在被控制。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_7', text: '「KPI 如果能照明，我們早就不會黑。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_8', text: '「這裡的螢幕光比大廳有人性——至少它會亮。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_9', text: '「我最討厭的特效是：全黑。還是免費的那種。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_casual_10', text: '「你要我信系統？可以，先讓系統信我。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_control_hint_1', text: '梁以安說：「我以為那次只是我倒霉。陳先生說，這個漏洞三館都有。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_control_hint_2', text: '「如果這不是偶發，那第一次——那個死掉的人——也不是偶發。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_control_hint_3', text: '「同一套版本……代表同一套可被利用的空隙。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_control_hint_4', text: '「品牌話術與機房母帶，遲早會在集團裡互相咬。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
    ],
    ...
    npcs: [
      {
        ...
        randomDialogs: [
          ...
          { id: 'ch4_liang_hall_casual_3', text: '「我人生第一次恨側門——它像 VIP 通道，給不需要入鏡的人。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_4', text: '「深色運動鞋如果算時尚，那天全場都在跑秀。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_5', text: '「廣播慢半拍這件事，跟我的人生很像——只是沒這麼吵。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_6', text: '「我當時想追人，也想救人——結果像同時丟兩顆球。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_7', text: '「大廳的燈一暗，我腦中先播的是片尾字幕——不是疏散。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_8', text: '「有人說混亂是觀眾的情緒。我覺得混亂像被排過程。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_9', text: '「我這輩子最討厭的轉場是：沒有轉場。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_casual_10', text: '「你要我冷静？可以，先讓燈按表走。」', type: 'casual', weight: 2 },
          { id: 'ch4_liang_hall_hint_1', text: '梁以安說：「那個人不是從主出口走的。他從側門出去，那邊沒有監視器。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_hall_hint_2', text: '「我想衝過去，但我不確定要救人還是跟著那個人。結果兩個都來不及。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_hall_hint_3', text: '「我記得鞋底摩擦的聲音。很快，像在躲什麼。」', type: 'hint', weight: 1 },
          { id: 'ch4_liang_hall_hint_4', text: '「你如果要我相信這是意外，先解釋順序為什麼會錯。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
      {
        ...
        randomDialogs: [
          ...
          { id: 'ch4_chen_hall_casual_2', text: '陳佑誠看向鞋印：「逃得快不代表心虛；但心虛的人通常都很快。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_3', text: '「面板旁邊這塊區域，按下去會很有成就感——如果你沒良心的話。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_4', text: '「側門沒鏡頭這件事，對觀眾是死角，對某些人來說是捷徑。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_5', text: '「共用帳號像共用雨傘：永遠不知道上一個是誰弄壞。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_6', text: '「我最討厭的腳步聲是：快、準、還不在 log 裡。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_7', text: '「大廳混亂的時候，最安靜的是誰？通常是系統後台。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_8', text: '「有人說這是意外。意外通常不會挑沒鏡頭的路走。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_9', text: '「指紋留在手動區，像留言：我來過，而且我知道我在幹嘛。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_casual_10', text: '「我這行最浪漫的事，是準時下班。今天顯然不浪漫。」', type: 'casual', weight: 2 },
          { id: 'ch4_chen_hall_hint_1', text: '陳佑誠說：「他知道哪個面板、哪個操作、哪個時機。不是隨機的，這是準備過的。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_hall_hint_2', text: '「如果你問我誰有能力做到這件事，我只能給你技術清單，不是一個名字。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_hall_hint_3', text: '「共用帳號這件事，你們晚點會在別的館再碰到一次。」', type: 'hint', weight: 1 },
          { id: 'ch4_chen_hall_hint_4', text: '「序列能被改，代表有人當時就在流程上游。」', type: 'hint', weight: 1 },
        ],
        available: true,
      },
    ],
