        ...
        effects: [
          {
            type: 'showDialog',
            dialog: {
              text: '劉隊說：「這章不是找新的物證，是把舊的物證拆清楚。」\n\n他把嫌疑矩陣的角落壓住，像怕它自己滑向結論。\n\n「你要弄清楚：高文傑是手，還是被借來的手。」\n\n「你也要弄清楚：林子睿在技術上有多深，他的名字在幾個地方。」\n\n他停一下，眼睛盯著桌面：「上面要名單，不要小說。但名單如果押錯，小說會變成下一章。」\n\n「阿蘇在比對 log，顧乃謙在拉插件結構。你去問他們，問完再回來。」',
              type: 'character',
              characterId: 'npc_liu',
        ...
        effects: [
          {
            type: 'showDialog',
            dialog: {
              text: '資料窗口說：「你知道上面最想先押誰嗎？」\n\n他沒等你回答：「登入紀錄最多的那個。因為這樣報告寫起來最省力。」\n\n他把話說得像流程：「先押一個名字，程序才走得動。走得動之後，真相走不走得動，就不是他們在乎的事。」\n\n「我不是叫你這樣做。」他補一句，「我是在告訴你壓力是怎麼運作的。你要做什麼，你自己決定。」',
              type: 'character',
        ...
        effects: [
          {
            type: 'showDialog',
            dialog: {
              text: '林子睿說：「你想問什麼，就直接問。」\n\n你問他最怕哪一種公開。\n\n他停頓了不到一秒：「我不怕公開。我怕的是公開了一半——讓複雜的事情被當成一個人的問題處理。」\n\n他像校準過一樣，把句子放得很穩：「系統複雜，不代表陰謀存在。多半只是管理落後。」\n\n他又補一句，仍然穩：「把結構問題說成個案，傷的是無辜的人。你同意嗎？」',
              type: 'character',
