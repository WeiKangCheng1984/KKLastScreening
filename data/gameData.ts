...
export const prologueSlides: string[] = [
  '凌晨00:39，你的手機震了一下。',
  '是一通沒有顯示來電的電話，像城市不想留下指紋。',
  '「KK？」對方壓低聲音，「偵查隊。需要你來一趟。」',
  '你坐起來，窗外的霓虹還亮著，像一部不肯散場的電影。',
  '「哪裡？」',
  '「城市影城。就在剛剛，散場後五分鐘左右，有一名看電影的人，死在H排12號。頸部壓迫，幾乎沒有掙扎。」',
  '你沒立刻回話，靜靜地聽著。',
  '對方接著說，像把真正的刀遞到你手上：',
    ...
    npcs: [
      ...
      },
      {
        ...
        randomDialogs: [
          {
            id: 'ch1_briefing',
            text: '「現場我們會先封著，你先快速看看，看到什麼，就照實說。」',
            type: 'hint',
            weight: 1,
          },
        ],
